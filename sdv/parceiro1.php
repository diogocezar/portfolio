					...
					<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row row-modo">
							<div class="box-dots">
								...
								<div class="col-lg-4 col-md-4 col-xs-4 col-left col-margin">
									<div class="half-box">
										<div class="half-line-inside line-right line-dotted"></div>
										<div class="half-labels-inside-numbers">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row row-ingredientes">
							<div class="col-lg-10 col-md-10 col-xs-10 col-right">
								<div class="half-box">
									<div class="half-line-inside"></div>
									<div class="half-labels-inside-numbers">
							...
							<div class="col-lg-10 col-md-10 col-xs-10 col-left col-margin"></div>
							<div class="col-lg-2 col-md-2 col-xs-2 col-left col-margin">
								<div class="half-box">
									<div class="half-line-inside line-right line-dotted"></div>
									<div class="half-labels-inside-numbers">
