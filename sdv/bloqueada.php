	...
	<body class="bg-dirty">
		...
		<section id="infos-bottom">
			<div class="container">
				...
				<div class="row row-footer hidden-xs">
					<div class="header-mobile">
						<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 padding-mobile" data-sr='enter top'>
							<a href="#" data-sr='enter right'><button class="btn btn-share">COMPARTILHAR</button></a>
			...
			<div class="blur">
				<div class="blur-in">
					<div class="container-blocked">
						<h3>Envie Essa Metade da receita para o seu amor:</h3>
						<button class="button-facebook button-hover-bloqueada" data-text="Facebook"><div class="icon-facebook"></div>Facebook</button>
						<button class="button-email button-hover-bloqueada" data-text="E-mail"><div class="icon-email"></div>E-mail</button>
						<div class="blocked-dots"></div>
						<button class="button-juntos button-hover-bloqueada" data-text="Já estamos juntos">Já estamos juntos</button>
					</div>
				</div>
			</div>
			<div class="container">
						...
						<div class="row row-ingredientes">
							<div class="box-dots">
								...
								<div class="col-lg-6 col-md-6 col-xs-6 col-right">
									<ul class="margin-right" data-sr='enter left'>
		...
		<section class="reciple reciple-mobile">
			<div class="container-fluid">
				<div class="blur-mobile">
					<div class="blur-in-mobile">
						<div class="container-blocked">
							<h3>Envie essa Receira para seu Amor.</h3>
							<h4>Compartilhe para desbloquear e preparar a dois.</h4>
							<button class="button-facebook"><div class="icon-facebook"></div>Facebook</button>
							<button class="button-email"><div class="icon-whats"></div>WhatsApp</button>
							<div class="blocked-dots"></div>
							<button class="button-juntos">Já estamos juntos</button>
						</div>
					</div>
				</div>
			</div>
