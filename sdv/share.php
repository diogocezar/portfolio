...
<html lang="pt-br" class="no-js">
	...
	<body class="bg-dirty">
		...
		<section id="share" class="bg-pink">
			<div class="content-popup">
				<div class="container">
					<div class="box-relative">
						<div id="popup-close-share" class="btn-close"></div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<h2>COMPARTILHAR</h2>
							<div class="row">
								<div class="col-xs-12">
									<div class="box-share">
										<div class="box-share-absolute">
								            <button class="share-button button-hover-share" data-text="Facebook"><span class="icon-facebook-share"></span>Facebook</button>
								            <button class="share-button button-hover-share" data-text="Twitter"><span class="icon-twitter-share"></span>Twitter</button>
								            <button class="share-button button-hover-share" data-text="E-mail"><span class="icon-email-share"></span>E-mail</button>
							            </div>
									</div>
						        </div>
						    </div>
