					...
					<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="row row-ingredientes">
							...
							<div class="col-xs-12 mobile-col-left">
								<ul class="margin-right" data-sr='enter right'>
									<li class="bullets-2">2 bananas nanicas não muito maduras cortadas em rodelas</li>
									<li class="bullets-2">1 colher (sopa) de açúcar</li>
									<li class="bullets-2">1 colher (chá) de gengibre em pó</li>
								</ul>
							</div>
							...
							<div class="col-xs-12 mobile-col-right">
								<ul class="margin-left mobile-right" data-sr='enter left'>
									<li class="bullets-1">3 bombons Sonho de Valsa - <div class="comprar">comprar<span class="icon-cart"></span></div></li>
									<li class="bullets-1">1 colher (sopa) de amêndoas em palitos</li>
									<li class="bullets-1">1 colher (sopa) de uvas-passas claras</li>
								</ul>
							</div>
						</div>
						<div class="row">
